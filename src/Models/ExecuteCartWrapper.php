 ...
 */
class ExecuteCartWrapper implements JsonSerializable {
    /**
     * @todo Write general description for this property
     * @var ExecuteCart $result public property
     */
    public $result;
     ...
     * @param   ExecuteCart       $result   Initialization value for the property $this->result
