 ...
 */
class UploadBarcodeWrapper implements JsonSerializable {
    /**
     * @todo Write general description for this property
     * @var UploadBarcodeResponse $result public property
     */
    public $result;
     ...
     * @param   UploadBarcodeResponse   $result   Initialization value for the property $this->result
