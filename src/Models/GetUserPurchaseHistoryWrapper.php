 ...
 */
class GetUserPurchaseHistoryWrapper implements JsonSerializable {
    /**
     * @todo Write general description for this property
     * @var PurchaseData $result public property
     */
    public $result;
     ...
     * @param   PurchaseData      $result   Initialization value for the property $this->result
