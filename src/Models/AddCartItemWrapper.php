 ...
 */
class AddCartItemWrapper implements JsonSerializable {
    /**
     * @todo Write general description for this property
     * @var CartItem $result public property
     */
    public $result;
     ...
     * @param   CartItem          $result   Initialization value for the property $this->result
