 ...
 */
class GetSingleUserPurchaseWrapper implements JsonSerializable {
    /**
     * @todo Write general description for this property
     * @var UserPurchase $result public property
     */
    public $result;
     ...
     * @param   UserPurchase      $result   Initialization value for the property $this->result
