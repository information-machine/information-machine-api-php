...
class UserPurchasesController {
     ...
     * @param  bool|null       $showProductDetails       Optional parameter: default:false [Show details of a purchased products (image, nutrients, ingredients, manufacturer, etc..)]
     * @param  bool|null       $receiptsOnly             Optional parameter: default:false [Filter out purchases transcribed from receipts.]
                ...
                $upcResolvedAfter = NULL) 
    {
        ...
        $queryBuilder = $queryBuilder.'/v1/users/{user_id}/purchases_product_based';
        ...
        APIHelper::appendUrlWithQueryParameters($queryBuilder, array (
            ...
            'show_product_details' => var_export($showProductDetails, true),
                ...
                $upcResolvedAfter = NULL) 
    {
        ...
        //prepare query string for API call
        $queryBuilder = $queryBuilder.'/v1/users/{user_id}/purchases_invoice_based';
     ...
     * @param  bool|null       $upcOnly                  Optional parameter: default:false [Filter out purchase items with UPC.]
     * @param  string|null     $upcResolvedAfter         Optional parameter: List only purchases having UPC resolved by IM after specified date. Expected format: "yyyy-MM-dd".
     * @param  string|null     $recordCreatedAfter       Optional parameter: List only purchases collected, i.e., database inserted by bots, after specified date. Not to be confused with purchase date (not existing for many loyalty purchases). Expected format: "yyyy-MM-dd"
     * @return mixed response from the API call*/
